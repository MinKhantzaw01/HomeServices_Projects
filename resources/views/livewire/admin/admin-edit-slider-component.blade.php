                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="" class="form-horizontal" wire:submit.prevent="updateSlide">
                                        ...
                                        <div class="form-group">
                                            <label for="title" class="label-control col-sm-3">Title:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="status" class="label-control col-sm-3">Status:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <button class="btn btn-success pull-right">Update Slider</button>
                                    </form>
                                </div>
                            </div>
                        </div>
