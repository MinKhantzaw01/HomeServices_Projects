                                ...
                                <div class="panel-body">
                                    ...
                                    <form action="" class="form-horizontal" wire:submit.prevent="updateService">
                                        ...
                                        <div class="form-group">
                                            <label for="name" class="label-control col-sm-3">Name:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="slug" class="label-control col-sm-3">Slug:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="tagline" class="label-control col-sm-3">Tagline:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="service_category_id" class="label-control col-sm-3">Service Category:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="price" class="label-control col-sm-3">Price:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="discount" class="label-control col-sm-3">Discount:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="discount_type" class="label-control col-sm-3">Discount Type:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="featured" class="label-control col-sm-3">Featured:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="description" class="label-control col-sm-3">Description:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="inclusion" class="label-control col-sm-3">Inclusion:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="exclusion" class="label-control col-sm-3">Exclusion:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="newThumbnail" class="label-control col-sm-3">Thumbnail:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <div class="form-group">
                                            <label for="newimage" class="label-control col-sm-3">Image:</label>
                                            <div class="col-sm-9">
                                        ...
                                        <button class="btn btn-success pull-right">Update Service</button>
                                    </form>
                                </div>
                            </div>
                        </div>
